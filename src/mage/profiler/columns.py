...
COLUMNS: dict[str, Column] = {
    ...
    "dram_util": Column(
        name="dram_util",
        header="DRAM Util %",
        getter=lambda m: m.dram_utilization,
        fmt=".1f",
        width=11,
        color_thresholds=(30.0, 70.0, "red", "yellow", "green"),
    ),
    "l1_util": Column(
        name="l1_util",
        header="L1 Util %",
        getter=lambda m: m.l1_utilization,
        fmt=".1f",
        width=10,
    ),
    "l2_util": Column(
        name="l2_util",
        header="L2 Util %",
        getter=lambda m: m.l2_utilization,
        fmt=".1f",
        width=10,
    ),
    "smem_util": Column(
        name="smem_util",
        header="SMem Util %",
        getter=lambda m: m.shared_utilization,
        fmt=".1f",
        width=11,
    ),
    "bank_conf": Column(
        name="bank_conf",
        header="Bank Conf",
        getter=lambda m: m.shared_bank_conflicts,
        fmt=",d",
        width=10,
        color_thresholds=(0, 100, "green", "yellow", "red"),
    ),
    "ld_eff": Column(
        name="ld_eff",
        header="Load Eff",
        getter=lambda m: m.global_load_efficiency * 100 if m.global_load_efficiency else None,
        fmt=".1f",
        width=9,
        color_thresholds=(50.0, 90.0, "red", "yellow", "green"),
    ),
    "st_eff": Column(
        name="st_eff",
        header="Store Eff",
        getter=lambda m: m.global_store_efficiency * 100 if m.global_store_efficiency else None,
        fmt=".1f",
        width=9,
        color_thresholds=(50.0, 90.0, "red", "yellow", "green"),
    ),
