...
Run: uv run --script scripts/plot-kernel-progression.py --experiment mage-006
...
mage-003 (80.00 / 10.05 us) and mage-006 (68.62 / 8.97 us). The remaining value --
...
FIGURES = {
    ...
    "mage-006": {"stages": 4, "alpha": (.42, .60, .80, 1.0), "rejected": (
...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiment", default=os.environ.get("MAGE_EXPERIMENT", "mage-006"),
